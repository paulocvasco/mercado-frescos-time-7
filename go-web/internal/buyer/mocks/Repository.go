...
func (_m *Repository) Create(CardNumberID string, FirstName string, LastName string) (models.Buyer, error) {
...
func (_m *Repository) GetAll() (models.Buyers, error) {
	ret := _m.Called()
...
func (_m *Repository) GetCardNumberId(id string) error {
	ret := _m.Called(id)
...
func (_m *Repository) GetId(id int) (models.Buyer, error) {
	ret := _m.Called(id)
...
func (_m *Repository) Update(id int, body models.Buyer) (models.Buyer, error) {
